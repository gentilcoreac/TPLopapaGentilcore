		...
		<tr>
			...
			<td>
				...
				<form  id=<%=te.getId()%> name="myForm" action="" method="post">
					...
					<button class="btn eliminar" type="submit" onclick="javascript: submitForm('ServletABMCTipoDeElemento?accion=baja',<%=te.getId()%>)" >Eliminar</button>	
					<button  class="btn btn-info btn-md" type="submit"  onclick="javascript: submitForm('ServletFormsTiposDeElementos?accion=modificacion',<%=te.getId()%>)"><span class="glyphicon glyphicon-pencil"></span></button>	
