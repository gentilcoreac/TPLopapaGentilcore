      ...
      <table>
       <tr><td>
      	  ...
      	  <input name="id" type="text" class="form-control" id="inputid"  required pattern="[1-9][0-9]*" oninvalid="setCustomValidity('Id invalido')" onchange="try{setCustomValidity('')}catch(e){}" value=<%=request.getAttribute("id")%> >
	   	  ...
	   	  &nbsp
	   	  <button formnovalidate onclick="javascript: submitForm('ServletABMCElemento?accion=consulta&fin=modificacion&urlcancelar=<%=request.getAttribute("urlcancelar") %>')" type="submit" class="btn btn-default btn-lg">
      ...
      <table>
       <tr><td>
      	  ...
      	  <input name="id" type="text" class="form-control" id="inputid"  required pattern="[1-9][0-9]*" oninvalid="setCustomValidity('Id invalido')" onchange="try{setCustomValidity('')}catch(e){}" value=<%=request.getAttribute("id")%> >
	   	  ...
	   	  <td align="center" valign="bottom">
	   	  &nbsp
	   	  <button formnovalidate onclick="javascript: submitForm('ServletABMCElemento?accion=consulta&fin=baja&urlcancelar=<%=request.getAttribute("urlcancelar") %>')" type="submit" class="btn btn-default btn-lg">
	      	<span class="glyphicon glyphicon-search"></span>
	      </button>
	   </td></tr> 
      </table>
